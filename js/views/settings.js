  ...
  btnCreateSpreadsheet.addEventListener('click', async () => {
    ...
    try {
      const spreadsheetId = await createSpreadsheet('ComprovaLattes', [
        { name: 'entradas', headers: ['id', 'titulo', 'instituicao', 'ano', 'carga_horaria', 'categoria', 'status', 'oculta', 'arquivo_drive_id', 'arquivo_nome', 'confianca', 'data_mapeamento', 'arquivo_hash', 'descricao'] },
